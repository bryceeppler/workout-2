...
const Workout = () => {
  ...
  const updateComment = api.workouts.updateComment.useMutation({
    onSuccess: () => {
      void utils.workouts.fetchComments.invalidate({ workoutId: Number(wid) });
                              ...
                              <div className="flex flex-col gap-3">
                                ...
                                <div className="flex w-full justify-between p-4">
                                  ...
                                  <div className="flex gap-3">
                                    {/* cancel button */}
                                    <div
                                      className="rounded border border-violet-400 px-4 py-1 text-xs font-semibold text-neutral-200 shadow transition-colors hover:bg-violet-400"
                                      onClick={(e) => {
                                        e.preventDefault();
                                        setEditComment(null);
                                      }}
                                    ...
                                    {/* submit button */}
                                    <div
                                      className="rounded border border-violet-400 bg-violet-500 px-4 py-1 text-xs font-semibold text-neutral-200 shadow transition-colors hover:bg-violet-400"
                                      onClick={(e) => {
                                        e.preventDefault();
